...
perfil_blue = Blueprint('perfil', __name__, template_folder='templates',url_prefix='/perfil')
#----------------------------Aluno-------------------------------------------------
@perfil_blue.route('/', methods=['POST'])
def perfil_aluno():
        return  render_template('/aluno/listar_aluno.html')
#----------------------------Aluno-------------------------------------------------
@perfil_blue.route('/cadastrar', methods=['POST'])
def cadastrar():
